...
- Copilot in PowerPoint with interactive slide creation available ('Create Interactive Slide' Skill is currently available to Frontier audience on desktop and mac).
